...
import com.calbitica.app.Models.Calbits;
...
//                    firebase.getWeekEventsFromFirebase();
                    ...
                    System.out.println("Week Fragment: " + e.getLocalizedMessage());
                }
    ...
    public void getAllCalbits() {
        // String eventDate = (start.containsKey("date")) ? data.get("date") : data.get("dateTime");
        ...
        apiCall.enqueue(new Callback<Calbits>() {
            ...
            public void onResponse(Call<Calbits> call, Response<Calbits> response) {
                ...
                for(int i = 0; i < allCalbits.getData().size(); i++) {
                    System.out.println(allCalbits.getData().get(i).getSummary());
                }
            }
