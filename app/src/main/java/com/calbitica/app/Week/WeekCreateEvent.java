            ...
            public void run() {
                for (int i = 0; i < data.getAllCalendars().size(); i++) {
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(getApplicationContext(),
                            android.R.layout.simple_spinner_item, calendarArrayValue);
...
*/
        // When selected the Spinner drop-down, the background color will change
        // accordingly
        // Due to some libraries require specific version, it become deprecated, for now
        // it will still work, but have to take note in future
        /*
         ...
         * position, long id) { String tutorialsName =
         * parent.getItemAtPosition(position).toString();
         * Toast.makeText(parent.getContext(), "Selected: " + tutorialsName,
         * Toast.LENGTH_LONG).show(); }
         * 
         * @Override public void onNothingSelected(AdapterView<?> parent) { // When no
         * selected, it will be default color } });
         */
