...
public class Firebase {
    ...
    // Save in Firebase
    public void saveInFirebase(long calendarID, String title, String startDateTime, String endDateTime, JSONObject colorInfo) {
    ...
    public void updateInFirebase(final long calendarID, final String title, final String startDateTime, final String endDateTime, final JSONObject colorInfo) {
    ...
    public void deleteFromFirebase (final long calendarID) {
